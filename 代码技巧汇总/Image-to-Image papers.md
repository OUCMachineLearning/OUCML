...
- [Supervised](https://github.com/ExtremeMart/image-to-image-papers#supervised)
- Unsupervised
    - [Unsupervised - General](https://github.com/ExtremeMart/image-to-image-papers#unsupervised---general)
    - [Unsupervised - Attention or Mask guided](https://github.com/ExtremeMart/image-to-image-papers#unsupervised---attention-or-mask-guided)
    - [Unsupervised - Many-to-many (Attributes)](https://github.com/ExtremeMart/image-to-image-papers#unsupervised---many-to-many-attributes)
    - [Unsupervised - Disentangled (and/or Exemplar guided)](https://github.com/ExtremeMart/image-to-image-papers#unsupervised---disentangled-andor-exemplar-guided)
